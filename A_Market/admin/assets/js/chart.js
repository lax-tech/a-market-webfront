    ...
    var myDoughnutChart = new Chart(doughnut, {
      ...
      options: {
        ...
        tooltips: {
          callbacks: {
            title: function(tooltipItem, data) {
              return "Commandes : " + data["labels"][tooltipItem[0]["index"]];
            },
            label: function(tooltipItem, data) {
              return data["datasets"][0]["data"][tooltipItem["index"]];
            }
  ...
  if (polar !== null) {
    var configPolar = {
      data: {
        ...
        labels: ["Total Sales", "Rejected", "Terminé", "En Attente", "Reserve"]
      },
      options: {
        responsive: true,
        maintainAspectRatio: false,
...
if (acquisition3 !== null) {
  var acChart3 = new Chart(acquisition3, {
    ...
    // The data for our dataset
    data: {
      labels: ["4 Janv", "5 Janv", "6 Janv", "7 Janv", "8 Janv", "9 Janv", "10 Janv"],
      datasets: [
        {
          label: "Referral",
...
if(typeof curveeml_ctx !== 'undefined' && curveeml_ctx !== null) {
  ...
  var chart = new Chart(ctx, {
      ...
      // The data for our dataset
      data: {
          labels: ["Sépt", "Oct", "Nov", "Dec", "Janv", "Févr", "Mars", "Avr"],
          datasets: [{
              label: "Income",
...
// var labels = ["January", "February", "March", "April", "Mai", "June", "July"];
